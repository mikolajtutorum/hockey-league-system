  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">{{ $player[0]->player_name }}</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
...
<img class="profile-user-img img-fluid img-circle" src="/uploads/teams/{{ $player[0]->player_avatar }}" alt="User profile picture">
</div>
<h3 class="profile-username text-center">{{ $player[0]->player_name }}</h3>
